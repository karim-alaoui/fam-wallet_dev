    ...
    <div class="p-memberEdit__contents">
            <div class="p-memberEdit__form__input__wrap">
                ...
                <?= $this->Form->control('role_id', [
                     ...
                     'options' => $roles,
                     'multiple' => false,
                     'class' => 'p-memberEdit__form__select'
                ]) ?>
                </div>
            </div>
            ...
            <?= $this->Form->button('変更',['class' => 'p-memberEdit__form__btn c-btn--orange']) ?>
            <div class="p-stampConfirm__btn c-btn--white"><a href="/members">戻る</a></div>
        <?= $this->Form->end() ?>
    </div>
    <div class="p-memberEdit__delete__wrap">
      <p class="p-memberEdit__delete jsc-modal-trigger">このアカウントを削除する</p>
    </div>
</div>
<div class="p-memberEdit__overlay model-overlay" style="display:none">
    <div class="p-memberEdit__modal">
        ...
        <div class="p-memberEdit__modal__btn__wrap">
            <?= $this->Form->button('キャンセル',['class' => 'p-memberEdit__modal__btn jsc-check-cancel c-btn--gray']) ?>
            <?= $this->Form->postButton('削除', ['controller' => 'Myusers', 'action' => 'delete', $myuser->id], ['class' => 'p-memberEdit__modal__btn jsc-check-decied c-btn--red']) ?>
        </div>
    </div>
</div>
