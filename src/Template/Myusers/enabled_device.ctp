<div class="p-enabledDevice">
    <section class="p-enabledDevice__title__wrap">
        <h1 class="p-enabledDevice__title">対応端末・利用方法</h1>
        <div class="p-enabledDevice__title__btn">
            <a href="javascript:history.back();">
                <p class="p-enabledDevice__title__arrowLeft"></p>
            </a>
        </div>
    </section>
    <div style="font-family: 'Inter';font-style: normal;padding-left: 1%;padding-top: 1%;padding-right: 2%;">
        <div>
