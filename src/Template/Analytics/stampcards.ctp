<div class="c-analytics">
    ...
    <div class="c-analytics__box">
        ...
        <div class="c-analytics__select__wrap">
            <?= $this->Form->control('stamp_list', ['type' => 'select', 'options' => $shop_list, 'multiple' => false , 'class' => 'c-analytics__select']) ?>
        </div>
        <?= $this->Form->button('店舗検索',['class' => 'p-couponEdit__form__btn c-btn--orange']) ?>
        <?= $this->Form->end() ?>
        <?= $this->Form->postlink('リセットする', ['action' => 'stampcards', '?' => ['reset' => 1]], ['class' => 'c-analytics__form__reset']) ?>
        ...
        <?php endif; ?>
        <p class="c-analytics__link"><a href="/analytics/stampcard_narrow_down">利用可能期間で絞り込む</a></p>
    </div>
    <div class="c-analytics__contents is-active" id="jsc-stamp-count"> <!-- 以下Stampcardsから各パラメータを引っ張ってくる -->
        <table class="c-analytics__table">
            <thead class="c-analytics__table__thead">
                <tr class="c-analytics__table__tr"> 
                    ...
                    <th class="c-analytics__filter__active jsc-download-stampcard" id="download">DL数</th>
                    <th class="c-analytics__filter__active jsc-last-updated-stampcard" id="last_updated">最終更新日</th>
                    <th class="c-analytics__filter__active jsc-create-date-stampcard" id="create_date">作成日</th>
                </tr>
            </thead>
